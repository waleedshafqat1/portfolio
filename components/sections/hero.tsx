...
import { site, heroTaglines, getYearsOfExperience } from '@/lib/data';
      ...
      <div className="container-page relative z-10 grid lg:grid-cols-12 gap-12 items-center">
        ...
        <div className="lg:col-span-7">
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-ink-200 dark:border-ink-800 bg-white/50 dark:bg-ink-900/50 backdrop-blur text-sm"
          >
        ...
        <div className="lg:col-span-5 hidden lg:block">
          ...
          >
            ...
            <motion.div
              ...
              className="absolute -top-4 -right-4 glass px-4 py-2 rounded-full shadow-lg"
            >
            ...
            <motion.div
              ...
              className="absolute -bottom-2 -left-2 glass px-4 py-2 rounded-full shadow-lg"
            >
            ...
            <motion.div
              ...
              className="absolute top-1/2 -right-8 glass px-4 py-2 rounded-full shadow-lg"
            >
            ...
            <motion.div
              ...
              className="absolute top-1/4 -left-10 glass px-4 py-2 rounded-full shadow-lg"
            >
