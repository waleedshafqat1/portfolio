...
export const skillGroups = [
  ...
  },
  {
    ...
    skills: [
      ...
      { name: 'Time Series Analysis', level: 93 },
  ...
  },
  {
    ...
    skills: [
      { name: 'SQL', level: 98 },
      { name: 'BigQuery', level: 97 },
      { name: 'ETL Pipelines', level: 93 },
      { name: 'Database Management', level: 92 },
      { name: 'Data Modeling', level: 93 },
    ],
  },
  {
    key: 'marketing',
    ...
    skills: [
      ...
      { name: 'Google Tag Manager', level: 91 },
      { name: 'Funnel Analysis', level: 92 },
